...
public record BrewAlchemistCauldronRecipe(FluidStack fluidIn, Ingredient reagent,
                                          List<FluidStack> results) implements Recipe<BrewAlchemistCauldronRecipe.Input> {
    ...
    public static class Builder implements RecipeBuilder {
        ...
        public void save(RecipeOutput recipeOutput, ResourceLocation id) {
            ...
            recipeOutput.accept(id, new BrewAlchemistCauldronRecipe(input, reagent, results), null);
        }
